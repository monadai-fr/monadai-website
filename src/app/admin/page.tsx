      ...
      >
        <motion.div variants={staggerItem}>
          <StatCard
            ...
            value={businessMetrics?.leadsThisWeek || 0}
            color="blue"
            icon={
        ...
        <motion.div variants={staggerItem}>
          <StatCard
            ...
            value={`${businessMetrics?.avgLeadScore || 0}/100`}
            color="green"
            icon={
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Score Qualité Leads</span>
              <span className="font-medium text-gray-900">
            ...
            <div className="pt-4 border-t border-gray-100">
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Leads Cette Semaine</span>
                <span className="font-bold text-green-600">
                  {businessMetrics?.leadsThisWeek || 0} nouveaux
                </span>
              </div>
            </div>
          </div>
